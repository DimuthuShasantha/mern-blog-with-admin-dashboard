      ...
      <div className="max-w-2xl p-3 mx-auto text-center">
        <div>
          ...
          <div className="flex flex-col gap-6 text-gray-500 text-md">
            <p>
              Welcome to Dimu's Blog! This blog was created by Dimuthu Shasantha
              Wicktamarathna as a personal project to share his thoughts and
              ideas with the world. Dimuthu is a passionate developer who loves
